...
* **Project Management:** Create and view personal projects.
* **Task Tracking:** Add tasks, delete tasks, and mark them as completed.
* **Data Persistence:** All data is stored in MongoDB Atlas.
* **Responsive UI:** Built with React and CSS for a clean user interface.
